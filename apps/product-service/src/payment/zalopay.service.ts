...
import { PaymentType } from '@app/proto-schema/proto/product.pb';
import { convertToObjectId, currencyFormatter } from '@app/utils';
...
export class ZaloPayService {
  ...
  async createPaymentURL(order: OrderEntity, paymentType: PaymentType) {
    ...
    try {
      ...
      throw new RpcException(sub_return_message);
    } catch (error) {
